...
import { useFetchTotalFailsHighest } from "@/hooks/useFetchTotalFailsHighest";

export function Fourth({ currID }: { currID: string }) {
	const { data, loading, error } = useFetchTotalFailsHighest(currID);
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Top 10 Professors - Highest Total Fails</CardTitle>
